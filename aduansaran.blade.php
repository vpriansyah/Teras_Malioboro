...
<div class="form-group">
    ...
    <input type="text" class="form-control" id="captcha" name="captcha" placeholder="Berapa hayooo">
    </div>
</div>

        <div class="form-group">
          <center>
                            <div class="rounded-pill btn btn-success">
                                <input id="submit" name="submit" type="submit" value="Kirim" class="rounded-pill btn btn-success" onsubmit="return validateForm();" onclick="return validateForm();">
                            </div>
</center>
                        </div>
