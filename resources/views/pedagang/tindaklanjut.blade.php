        ...
        <section class="container py-5 text-center text-white rounded bg-success">
            <div class="row py-lg-5">
                <div class="col-lg-6 col-md-8 mx-auto">
                    ...
                    <p class="lead">Tindak lanjut merupakan halaman yang dikhususkan untuk pedagang dalam menerima
                        informasi mengenai tindak lanjut yang telah direalisasikan dari halaman aduan dan saran</p>
                </div>
            </div>
        </section>
                    ...
                    @foreach ($tindak_lanjut as $tindak)
                        ...
                        <div class="col">
                            <div class="card shadow-sm">
                                ...
                                @endphp
                                <img width="100%" height="225px" src="{{ asset('storage/' . $tindak->Foto) }}"
                                    alt="">
                                <div class="card-body">
                                    <h5>{{ $tindak->Judul }}</h5>
                                    <div class="card-text">{{ $desc }}</div>
                                    <div class="card-text collapse" id="demo{{ $tindak->id_tindaklanjut }}">
                                        {{ $desc2 }}</div>
                                    <!-- <p class="card-text collapse" id="demo{{ $tindak->id_tindaklanjut }}">{{ $tindak->Deskripsi }}</p> -->
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="btn-group">
                                            <button data-bs-target="#demo{{ $tindak->id_tindaklanjut }}"
                                                class="readmore-btn btn btn-sm btn-success" data-bs-toggle="collapse">Baca
                                                Lengkap</button>
                                        </div>
                                    </div>
                                </div>
