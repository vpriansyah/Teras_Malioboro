                ...
                <form action="{{ route('profil.update', $data_pkl->id) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" id="no_kk" name="no_kk"
                            value="{{ $data_pkl->no_kk }}" required>
                    </div>
                    <div class="mb-3">
                        <label for="exampleFormControlInput1" class="form-label">Nomor NIB</label>
                        <input type="number" class="form-control" id="nomor_nib" name="nomor_nib"
                            value="{{ $data_pkl->nomor_nib }}">
                    </div>
