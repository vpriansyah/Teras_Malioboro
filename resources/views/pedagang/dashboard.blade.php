                ...
                <div class="col-sm-12">
                    <nav class="navbar navbar-expand-lg navbar-light">
                        <a class="navbar-brand" href="">
                            <img class="img-fluid logo_img" id="logo_img" src="images/Logo SiBakul.png">
                        </a>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 iq-mtb-15">
                    <div class="iq-blog text-left iq-ptb-30 iq-pr-30 iq-pl-30">
                        <div>
                            ...
                            <h5 class="iq-tw-6">CCTV Teras</h5>
                        </div>
                        <div class="content-blog">
                            <p>Memudahkan pengunjung melihat keramaian dan memutuskan membeli online atau datang
                                langsung</p>
                        </div>
                    </div>
                </div>
