                    ...
                    <div class="border p-4 rounded rounded-lg shadow-md">
                        ...
                        <form action="/pedagang/input/" method="post">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="nama" class="form-control border border-success" id="nama"
                                    placeholder="Masukkan nama anda">
                            </div>
                            <div class="mb-3">
                                <label for="jenis" class="form-label text-body">Jenis Aduan</label>
                                <select class="form-select border border-success " aria-label="Default select example" name="jenis" required>
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select border border-success" aria-label="Default select example" name="id_kategori" required>
                                    <option selected>Klik untuk pilih</option>
